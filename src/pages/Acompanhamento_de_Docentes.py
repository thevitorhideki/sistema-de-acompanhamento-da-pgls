...
if teacher != 'Nenhum':
    ...
    df_feedbacks_likert = df_feedbacks_likert[df_feedbacks_likert['questionSubCategory']
                                != 'Avaliação Geral']
    ...
    df_feedbacks_likert = df_feedbacks_likert[df_feedbacks_likert['classCode'].isin(
        classes_to_show)]
    ...
    for index, row in survey_info_grouped.iterrows():
        ...
        with col1:
            if row['totalExpectedSurveys'] == float:
